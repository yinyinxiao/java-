	...
	<body>
		<form id="form_1" action="false">
                	<ul>
                		...
                		<li ><input id="sub_1" type="submit" name="S_submit" value="学生登陆"class="sub_1"/><input class="sub_1" id="sub_2" type="submit" name="T_submit"value="教师登陆" /><a href="reg.html" id="a_1">还未注册,注册</a></li>
                	</ul>
